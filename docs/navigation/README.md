...
| `00-readme-details.md` | 需要根 README 的扩展说明、开源贡献、安全边界、详细阅读路线或文档地图时读取。 | 不要把所有新增说明继续塞回根 README。 |
...
- 根 README 只保留项目定位、快速使用、核心入口和关键原则；长说明下沉到 `00-readme-details.md`。
...
| 根 README 太短，需要更多开源说明 | `00-readme-details.md` |
