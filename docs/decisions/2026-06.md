...
影响范围：`docs/07-continuity-ledger.md`、`docs/38-chapter-production-pipeline-agent-handoff.md`、`docs/58-integrated-drafting-beta-review-revision-workflow.md`、`docs/10-templates-and-checklists.md`、`AGENTS.md`。
...
影响范围：`AGENTS.md`、`docs/00-index.md`、`docs/64-single-novel-project-document-granularity.md`、单本小说项目初始化和维护流程。
