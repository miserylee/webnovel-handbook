...
| `57-long-timeskip-state-compression.md` | 长时间跳跃、状态压缩和剧情跨期承接 |
| `58-integrated-drafting-beta-review-revision-workflow.md` | 写手、试读、审稿、改稿一体化闭环 |
| `58-training-growth-anti-padding.md` | 修炼、训练、成长线防水和阶段回报 |
| `64-single-novel-project-document-granularity.md` | 单本小说项目短文档、多索引和巨型文件治理 |
| `64-iconic-scene-character-highlight-shareable-moment.md` | 名场面、人物高光和可传播瞬间 |
