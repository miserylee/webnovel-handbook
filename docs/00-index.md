...
- `docs/governance/01-changelog-detail-archive.md`：只在追溯具体变更细项、排查历史维护动作或准备发布说明时按日期/关键词读取。
...
- `docs/market-serialization/14-platform-and-reader-binding.md`
...
- `docs/governance/01-changelog-detail-archive.md`：根变更日志下沉出的详细维护流水归档；只在追溯具体变更细项、排查历史维护动作或准备发布说明时按日期/关键词读取。
...
### 6.5 `docs/governance/01-changelog-detail-archive.md`

用途：根 `CHANGELOG.md` 下沉出来的详细维护流水归档。只在追溯具体变更细项、排查历史维护动作或准备发布说明时读取。

推荐检索方式：按日期、提交主题、文件路径或维护动作关键词定位，不要因为它和根变更日志有关就整篇读取。

### 6.6 `docs/navigation/01-readme-details.md`
