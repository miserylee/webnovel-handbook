...
- 影响：`docs/00-index.md` 是薄启动索引；`docs/00-expanded-topic-catalog.md`、`docs/01-source-inventory.md`、`docs/10-templates-and-checklists.md` 只做定向检索。
...
- 状态：已确认
- 归档：`docs/decisions/2026-06.md`
- 影响：`README.md`、`docs/00-readme-details.md`
- 执行口径：根 README 只承担开源门面、快速使用和核心入口；详细任务路线、贡献、安全和维护说明下沉到 `docs/00-readme-details.md`。
...
- 状态：已确认
- 归档：`docs/decisions/2026-06.md`
- 影响：`AGENTS.md`、`docs/03-project-workflow.md`、`docs/57-knowledge-base-routing-consolidation-guide.md`
...
- 状态：已确认
- 归档：`docs/decisions/2026-06.md`
- 影响：`docs/59-dialogue-comparison-reference.md`
...
- 状态：已确认
- 归档：`docs/decisions/2026-06.md`
- 影响：`docs/17-cover-visual-packaging.md`
...
- 状态：已确认
- 归档：`docs/decisions/2026-06.md`
- 影响：`AGENTS.md`、`docs/00-index.md`、`docs/64-single-novel-project-document-granularity.md`
